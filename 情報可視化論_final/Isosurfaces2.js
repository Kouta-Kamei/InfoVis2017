function Isosurfaces2( volume, isovalue,r,g,b,screen)
{
    var geometry = new THREE.Geometry();
    var S = document.getElementById("Sdrop")
    var R = document.getElementById("Rdrop")
                if(S.value == "L" && R.value == "L"){
